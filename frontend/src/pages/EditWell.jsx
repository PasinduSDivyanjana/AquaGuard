      ...
      <div className="flex items-start justify-between gap-4 mb-5">
        <div>
          ...
          <p
            ...
            style={{ color: "var(--text-secondary)" }}
          >
            Update location, status, and verify field conditions with live
            weather data.
          </p>
        </div>
      ...
      <div className="grid gap-6 lg:grid-cols-[1.6fr_1fr]">
        <form
          ...
          style={{
            ...
            borderColor: "rgba(245, 189, 39, 0.2)",
          }}
        >
        ...
        <div className="space-y-4">
          {photos.length > 0 && (
            <div
              className="card p-4"
              style={{ backgroundColor: "rgba(16, 22, 36, 0.92)" }}
            >
              <h3
              ...
              >
                ...
                <p>
                  ...
                  {weather.summary?.humidity != null &&
                    ` · ${weather.summary.humidity}% humidity`}
                </p>
                <p>
                  Rain:{" "}
                ...
                <p className="capitalize">
                  Trend: {weather.summary?.waterLevelTrend || "—"}
                </p>
              </div>
            ) : (
              <p className="text-sm" style={{ color: "var(--text-secondary)" }}>
